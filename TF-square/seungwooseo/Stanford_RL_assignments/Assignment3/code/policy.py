...
class BasePolicy:
    ...
    def act(self, observations):
        ...
        dist_over_act = self.action_distribution(observations)
        sampled_actions = dist_over_act.sample().numpy()
        #######################################################
        #########          END YOUR CODE.          ############
...
class GaussianPolicy(BasePolicy, nn.Module):
    ...
    def action_distribution(self, observations):
        ...
        distribution = torch.distributions.MultivariateNormal(loc=self.network(observations),
