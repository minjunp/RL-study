...
class BaselineNetwork(nn.Module):
    ...
    def __init__(self, env, config):
        ...
        self.network = build_mlp(self.env.observation_space.shape[0],
                                 1, self.config.n_layers, self.config.layer_size)
    ...
    def update_baseline(self, returns, observations):
        ...
        loss = torch.mean((returns - self.forward(observations))**2)
