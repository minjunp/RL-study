...
def policy_evaluation(P, nS, nA, policy, gamma=0.9, tol=1e-3):
    ...
    while diff > tol:
        ...
        for i in range(len(policy)):
            ...
            vf2[i] = calculate_value(
                reward, gamma, probability, value_function[nextstate]
            )
...
def policy_improvement(P, nS, nA, value_from_policy, policy, gamma=0.9):
    ...
    for s in range(nS):
        ...
        for a in range(nA):
            ...
            v = calculate_value(
                reward, gamma, probability, value_from_policy[nextstate]
            )
        ...
        for s in range(nS):
            ...
            for a in range(nA):
                ...
                action_values.append(
                    calculate_value(reward, gamma, probability, vf2[nextstate])
                )
