...
class ClinicalDosingPolicy(StaticPolicy):
	def choose(self, x):
		...
		enzyme_inducer_status = max(x['Carbamazepine (Tegretol)'], x['Phenytoin (Dilantin)'], x['Rifampin or Rifampicin'])
...
class LinUCB(BanditPolicy):
	def __init__(self, n_arms, features, alpha=1.):
		...
		# print('cp-1.5')
		# # print(self.n_arms)
		# print(np.array([np.identity(len(self.features))]*self.n_arms).shape)
		# print('cp-2')
